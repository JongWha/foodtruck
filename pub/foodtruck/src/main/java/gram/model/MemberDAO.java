...
public class MemberDAO {
	...
	public static int joinMember(String inputMemberId, String inputMemberPassword, int inputMemberStatus){
		...
		try {
			...
			return (Integer) sqlSession.insert(namespace +".joinMember", map);
		} finally {
			sqlSession.close();
		}
	}
